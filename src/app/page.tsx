    ...
    <main>
      ...
      <header className="site-header"><div className="container header-inner">
        <a href="#home" className="brand" aria-label="Tanvi Dental Care & Implant Centre">
          <img src="/images/tanvi-logo-web.png" alt="" />
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-image-layer"><img src="/images/tanvi-doctors-hero.jpg" alt="Dr. Naga Swathi Pokala and Dr. Prathap Naidu" width="664" height="451" fetchPriority="high" decoding="async" /></div>
      </section>
      ...
      <footer className="footer"><div className="container footer-inner"><div className="footer-brand"><img src="/images/tanvi-logo-web.png" alt="" /><span><strong>TANVI</strong><small>DENTAL CARE &amp;<br />IMPLANT CENTRE</small></span></div><p>Tanvi Dental Care &amp; Implant Centre - Mangalagiri, Andhra Pradesh</p></div></footer>
